    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      ...
      <Card className="w-full max-w-md bg-[rgba(15,15,30,0.8)] border border-white/10 shadow-2xl relative z-10">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join StudyPilot AI today and ace your exams</CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <p className="text-xs text-muted-text text-center">
              ...
              <Link href="/login" className="text-primary-indigo hover:text-primary-violet font-semibold transition-colors">
                Log In
              </Link>
            </p>
          </CardFooter>
